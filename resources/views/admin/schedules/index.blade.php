...
<div class="container mx-auto px-4 w-full">
    <div class="d-flex justify-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.schedules.completed') }}" class="btn btn-primary btn-sm">
                <i class="fas fa-check-double"></i> Completed Schedules
            </a>
            <a href="{{ route('admin.reports.index') }}" class="archived-link ml-2">
