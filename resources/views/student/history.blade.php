...
<div class="min-h-screen bg-gray-100">
    <div class="w-full max-w-full px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            @else
                <!-- Desktop Table View with Auto Layout -->
                        ...
                        <table class="w-full table-fixed">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($allSchedules as $schedule)
                                    ...
                                    <!-- Expandable Row for Additional Details (Desktop) -->
                                    @if($schedule->status == 'rejected' && $schedule->remarks || $schedule->reason)
                                        <tr class="hidden sm:table-row bg-gray-50">
                                            <td colspan="5" class="px-6 py-4 text-sm">
                                                <div x-data="{ expanded: false }" class="w-full">
                                                    <button 
                                                        @click="expanded = !expanded" 
                                                        class="flex items-center justify-center w-full py-2 text-sm text-gray-600 hover:text-gray-900 focus:outline-none"
                                                        aria-expanded="false"
