...
<div x-data="{ open: false }" class="bg-gray-800 fixed w-full z-20 top-0 left-0 px-4 sm:px-6 py-4 text-white shadow-lg">
    <div class="container flex justify-between items-center mx-auto">
        ...
        <a href="
            ...
            <span class="text-lg font-semibold hidden md:block text-blue-400">PRMSU San Marcelino Document Request Portal</span>
            <span class="text-lg font-semibold block md:hidden text-blue-400">PRMSU-SM File Portal</span>
